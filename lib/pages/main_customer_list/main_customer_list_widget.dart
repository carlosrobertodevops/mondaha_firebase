                        ...
                        child: Container(
                          ...
                          child: StreamBuilder<List<MembrosRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<MembrosRecord> tabBarMembrosRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final tabBarMembrosRecord =
                                  tabBarMembrosRecordList.isNotEmpty
                                      ? tabBarMembrosRecordList.first
                                      : null;
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_CUSTOMER_LIST_Icon_jmyz1m78_ON_TAP');
                                                                            await showAlignedDialog(
                                                                              barrierColor: Colors.transparent,
                                                                              context: context,
                                                                              isGlobal: false,
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_CUSTOMER_LIST_Icon_1w2ljq6j_ON_TAP');
                                                                            await showAlignedDialog(
                                                                              barrierColor: Colors.transparent,
                                                                              context: context,
                                                                              isGlobal: false,
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_CUSTOMER_LIST_Icon_ri4npszv_ON_TAP');
                                                                            await showAlignedDialog(
                                                                              barrierColor: Colors.transparent,
                                                                              context: context,
                                                                              isGlobal: false,
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_CUSTOMER_LIST_Icon_1p66kfb2_ON_TAP');
                                                                            await showAlignedDialog(
                                                                              barrierColor: Colors.transparent,
                                                                              context: context,
                                                                              isGlobal: false,
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_CUSTOMER_LIST_Icon_avaox4r0_ON_TAP');
                                                                            await showAlignedDialog(
                                                                              barrierColor: Colors.transparent,
                                                                              context: context,
                                                                              isGlobal: false,
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_CUSTOMER_LIST_Icon_pz00dir6_ON_TAP');
                                                                            await showAlignedDialog(
                                                                              barrierColor: Colors.transparent,
                                                                              context: context,
                                                                              isGlobal: false,
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('MAIN_CUSTOMER_LIST_Icon_rderf6e5_ON_TAP');
                                                                            await showAlignedDialog(
                                                                              barrierColor: Colors.transparent,
                                                                              context: context,
                                                                              isGlobal: false,
