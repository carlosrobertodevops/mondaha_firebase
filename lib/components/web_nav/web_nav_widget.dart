    ...
    return Padding(
      ...
      child: StreamBuilder<List<UsersRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<UsersRecord> webNavBgUsersRecordList = snapshot.data!;
          // Return an empty Container when the item does not exist.
          if (snapshot.data!.isEmpty) {
            return Container();
          }
          final webNavBgUsersRecord = webNavBgUsersRecordList.isNotEmpty
              ? webNavBgUsersRecordList.first
              : null;
                                ...
                                child: Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      fadeOutDuration:
                                          const Duration(milliseconds: 500),
                                      imageUrl: webNavBgUsersRecord!.photoUrl,
                                      width: 44.0,
                                      height: 44.0,
                                      fit: BoxFit.cover,
                                    ),
                                        ...
                                        children: [
                                          Text(
                                            valueOrDefault<String>(
                                              webNavBgUsersRecord.displayName,
                                              'nome',
                                            ),
